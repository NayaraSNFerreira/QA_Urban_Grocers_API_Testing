...
`Postman` `Jira` `API Testing` `Testes manuais` `Análise de requisitos` `Checklist de testes` `JSON`
...
Projeto desenvolvido como parte do **Bootcamp de Analista de QA da TripleTen**.

Esta documentação apresenta um resumo das atividades realizadas durante a formação, sem reproduzir materiais proprietários, requisitos ou arquivos originais da plataforma.
